...
def get_data(TIME_POINT):
    ...
    X = final_adata
    Y = final_adata.obs['encoded_condition']
    ...
    train_dataset = data.Dataset.from_tensor_slices((train_input, y_train.astype(np.int64)))
    test_dataset = data.Dataset.from_tensor_slices((test_input, y_test.astype(np.int64)))
